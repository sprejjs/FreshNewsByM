...
public class QueryUtils {
     ...
     */
    public static ArrayList<FreshNews> extractFreshNews() {

        // Create an empty ArrayList that we can start adding fresh news to
        ArrayList<FreshNews> freshNewsArrayList = new ArrayList<>();
        ...
        try {
            ...
            JSONArray freshNewsArrayJson = baseJsonResponse.getJSONArray("features");
            ...
            for (int i = 0; i < freshNewsArrayJson.length(); i++) {
                ...
                String headline = properties.getString("place");
                String byline = properties.getString("time");
                String date = properties.getString("updated");
                String section = properties.getString("tz");
